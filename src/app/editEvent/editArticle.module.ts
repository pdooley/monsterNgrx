...
import {EditEventComponent} from './components/editArticle/editEvent.component'
import {UpdateEventEffect} from './store/effects/updateEvent.effect'
import {GetEventEffect} from './store/effects/getEvent.effect'
...
@NgModule({
  imports: [
    ...
    ArticleFormModule,
    EffectsModule.forFeature([UpdateEventEffect, GetEventEffect]),
